    ...
    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
      ...
      <form class="form-horizontal" role="form">
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" value="Madan" type="text">
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-3 control-label">Last name:</label>
          <div class="col-lg-8">
            <input class="form-control" value="Tamang" type="text">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" value="click2madan@gmail.com" type="text">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input class="form-control" value="madan.tamang" type="text">
          </div>
        </div>
        <div class="form-group">
